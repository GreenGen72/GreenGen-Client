  ...
  return (
    <div className="p-4 flex-grow bg-slate-50">
      ...
      <div className="border-l-4 border-r-4 border-green-500 p-4 space-y-6">
        ...
        <p className="text-2xl font-bold mb-4 text-center text-green-700">
          Nosso time
        </p>
        <div
 ...
 justify-center items-center text-center"
        >
          <div className="flex flex-col justify-center items-center text-center hoverSB">
            <img
              src="https://media.licdn.com/dms/image/D4D03AQHFpp1_HjjM0g/profile-displayphoto-shrink_200_200/0/1719181975880?e=1724889600&v=beta&t=IgMmnJ6M7SvTL0lDrjOAmdicI9jeZ5-_jvBCTpp4T2k"
              width="100px"
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.linkedin.com/in/apenasgabs/" target="_blank">
                <LinkedInIcon />
              </a>
            </div>
          </div>
          <div className="flex flex-col justify-center items-center text-center hoverSB">
            ...
            <div className="flex gap-4">
              <a href="https://github.com/dori-minante " target="_blank">
                <GithubIcon />
              </a>
              <a
                href="https://www.linkedin.com/in/dorivaniasm/"
                target="_blank"
              >
                <LinkedInIcon />
              </a>
          ...
          <div className="flex flex-col justify-center items-center text-center hoverSB">
            <a href="https://github.com/Jonathangaruti"></a>
            <img
            ...
            <div className="flex gap-4">
              <a href="https://github.com/Jonathangaruti" target="_blank">
                <GithubIcon />
              </a>
              <a
                href="https://www.linkedin.com/in/jonathangaruti/"
                target="_blank"
              >
                <LinkedInIcon />
              </a>
          ...
          <div className="flex flex-col justify-center items-center text-center hoverSB">
            <a href="https://github.com/NandayGB"></a>
            <img
            ...
            <div className="flex gap-4">
              <a href="https://github.com/NandayGB" target="_blank">
                <GithubIcon />
              </a>
              <a
                href="https://www.linkedin.com/in/barbosaafernanda/"
                target="_blank"
              >
                <LinkedInIcon />
              </a>
          ...
          <div className="flex flex-col justify-center items-center text-center hoverSB">
            ...
            <div className="flex gap-4">
              <a href="https://github.com/RaviBrito" target="_blank">
                <GithubIcon />
              </a>
              <a href="https://www.linkedin.com/in/ravi-brito/" target="_blank">
                <LinkedInIcon />
              </a>
            </div>
          </div>
          <div className="flex flex-col justify-center items-center text-center hoverSB">
            ...
            <div className="flex gap-4">
              <a href="https://github.com/tainapoppi" target="_blank">
                <GithubIcon />
              </a>
              <a href="https://www.linkedin.com/in/tainapoppi/" target="_blank">
                <LinkedInIcon />
              </a>
            </div>
          </div>
          <div className="flex flex-col justify-center items-center text-center hoverSB">
            ...
            <div className="flex gap-4">
              <a href="https://github.com/devgabrielnascimento" target="_blank">
                <GithubIcon />
              </a>
              <a
                href="https://www.linkedin.com/in/devgabrielnascimento"
                target="_blank"
              >
                <LinkedInIcon />
              </a>
