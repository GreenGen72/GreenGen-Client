...
function Home() {
    ...
    return (
        <>
            <main className="bg-lite-grey h-full flex items-center justify-center flex-grow overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-center">
                    <section
                        className="col-span-full md:col-span-2 lg:col-span-3 grid grid-cols-3 gap-4 content-center items-center">
                        <div className="flex content-center justify-center items-center p-5">
                            <FontAwesomeIcon icon={faTruck} className="text-main-green mr-3" size="2x"/>
                            <span className="text-lg">Entrega Flash <br/> em até 24h</span>
                        </div>
                        <div className="flex items-center justify-center p-5">
                            <FontAwesomeIcon icon={faCreditCard} className="text-main-green mr-3" size="2x"/>
                            <span className="text-lg">Parcele em até 12x <br/> no cartão de crédito</span>
                        </div>
                        <div className="flex items-center justify-center  p-5">
                            <svg fill="text-main-green" className="text-main-green mr-3" xmlns="http://www.w3.org/2000/svg" width="32"
                            ...
                            <span className="text-lg">5% no Pix <br/> Pagamento à vista</span>
                        </div>
                    </section>
                    ...
                    {/* Seção de Botões e Mensagens */}
                    <section className="col-span-full md:col-span-2 lg:col-span-3 flex justify-center md:justify-start">
                        <button className="rounded bg-blue-800 text-white m-3 p-1">
                            Lançamentos
                        </button>
                    </section>

                    {/* Lista de Produtos */}
                    <div className="col-span-full md:col-span-2 lg:col-span-1 flex-grow relative z-0">
                        <ListaProdutos/>
                    </div>
                </div>
            </main>
